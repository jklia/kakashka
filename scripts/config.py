...
field = Fields.fields[1]  # 0 - Стандартное поле, 1 - карта №1, 2 - пустое поле, 3 - карта №2
music_volume = 0.1
...
pause_flag = False  # Работа ботов (сейчас есть кнопка)
stress_test_flag = False  # Стресс-тест для игры
