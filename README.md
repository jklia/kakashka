...
* Цель игры Antiyoy заключается в том, чтобы захватывая территории, управляя своими ресурсами и побеждая противников
...
* **Армия**: Игроки могут формировать армию, включающую различные типы юнитов, такие как крестьяне, рыцари и лорды,
...
* **Разные режимы игры:** В Antiyoy представлены различные режимы игры, включая одиночную игру против компьютера и
